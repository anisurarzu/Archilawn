  ...
  return (
    <section className="bg-[#F3F3F9]  lg:h-[680px] md:h-[1000px] pb-10 shadow-sm">
      <div className="container mx-auto">
        ...
        <div className="hidden lg:grid md:grid grid-cols-1 gap-3 bg-white shadow-2xl lg:h-[320px] md:h-[650px] h-1020px] py-12 px-10 rounded-[30px] md:grid-cols-2 lg:grid-cols-3">
        ...
        {/* Mobile Device Start */}
        <div className="flex flex-col md:hidden lg:hidden gap-12 mx-2 bg-white shadow-xl py-8 px-8 rounded-[30px] md:grid-cols-2 lg:grid-cols-3">
          <div className="">
